...
async def generate_problem(req: GenerateRequest):
    if req.topic != "aljabar/linear":
        raise HTTPException(status_code=400, detail="Topic not fully supported yet")
...
{{
  ...
  "steps": [
    ...
    // ...tambahkan langkah selanjutnya untuk melengkapi penyelesaian hingga 'x = {ans}'
  ]
}}
